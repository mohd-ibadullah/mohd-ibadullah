...
|---------|------|--------|------------|
| **Prompt Injection Detection** | — | [Repo](https://github.com/mohd-ibadullah/prompt-injection-detection) | 3-model ensemble · 95.92% recall · hybrid remediation · 99.84% utility · Zenodo preprint |
